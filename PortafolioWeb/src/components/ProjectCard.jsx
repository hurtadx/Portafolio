      ...
      <div className="project-image">
        ...
        <img 
          ...
          onError={() => {
            ...
            setImageError(true);
            // Fallback a imagen de placeholder si hay error
      ...
      <div className="project-info">
        ...
        {hasExtendedDetails && showDetails ? (
          <div className="extended-details">
            <p>{extendedDetails[project.title].description}</p>
            
            <div className="detail-section">
              <h4>Características</h4>
              <ul>
                {extendedDetails[project.title].features.map((feature, i) => (
                  <li key={i}>{feature}</li>
                ))}
              </ul>
            </div>
            ...
            <div className="detail-section">
              <h4>Tecnologías</h4>
              <ul>
                {extendedDetails[project.title].technologies.map((tech, i) => (
                  <li key={i}>{tech}</li>
                ))}
              </ul>
            </div>
            ...
            {extendedDetails[project.title].note && (
              <div className="detail-section project-note">
                <p><strong>Nota:</strong> {extendedDetails[project.title].note}</p>
              </div>
            )}
